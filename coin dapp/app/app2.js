...
Coin.prototype.getBalance = function(address, cb) {
    coin.balances(address, function(error, result) {
        cb(error, result);
    })
}
...
Coin.prototype.createTokens = function() {
    ...
    coin.mint(address, amount, { from: window.web3.eth.accounts[0], gas: 100000, gasPrice: 100000, gasLimit: 100000 }, 
